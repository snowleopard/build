...
\item \Buck~\cite{buck} and \CloudBuild~\cite{esfahani2016cloudbuild} are both
fundamentally similar to \Bazel, differing around areas such as
non-determinism~\S\ref{sec-non-determinism}.
