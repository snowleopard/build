...
\item \Pluto \cite{pluto} has power to express cyclic dependencies, but that is implemented \todo{NM}{Read the paper so I can say something precise}
\end{itemize}
...
While not typically considered build systems, self-adjusting computation is a well studied area, and in particular the contrast between different formulations has been well studied. \todo{AM}{Say something.}

\subsection{Profunctor Optics}\label{sec-related-optics}

The \hs{Task} definition of:
