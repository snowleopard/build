...
more context and examples in the rest of this section, we will be able to
...
executes some of them in an order that respects their dependencies to produce a
...
corresponding tasks are independent, and will then build \cmd{main.exe}. If the
user modifies the sources of the utility library and runs \Make again, it will
