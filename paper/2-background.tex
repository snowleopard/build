...
For example\footnote{Do not worry about the dependency on \cmd{stdio.h}, and its transitive (perhaps dynamic) dependencies.  We will deal with these in Section \simon{xxx}.}:
