...
$\{\cmd{C1},\cmd{A1}\}$, otherwise they are $\{\cmd{C1},\cmd{A2}\}$, which is
...
\cmd{A2}, \Excel will not require \cmd{B1} to be computed in advance. Alas, other forms of
...
build~\cite{excel_recalc}. This approach clearly violates the minimality
