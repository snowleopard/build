...
executing the build task, rebuild \cmd{report.txt} by downloading it from the
cloud, resulting in a Frankenbuild. New and evicted cloud storage entries are
highlighted.\label{fig-frankenbuild}}
\vspace{-3mm}
\end{figure}
