...
isolated from the world of compilers, file systems, calculation chains, memories,
caches, and all other complexities of real build systems. We explain the compute
type in~\S\ref{sec-general-compute}, and then discuss several noteworthy special
...
Sections~\S\ref{sec-build} and~\S\ref{sec-implementations} further deconstruct
build algorithms and provide concrete implementations for several build systems.
