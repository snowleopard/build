...
\todo{NM}{What about using shorter \hs{get} and \hs{put}? I can introduce it right in the common vocabulary, mentioning the usual get-put laws. I would also remove `get' prefixes from many functions, e.g. \hs{dependencies compute} reads fine. This is a minor issue, happy to do this at the end.}
