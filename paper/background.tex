...
Note that it is not always possible to know the dependencies of a source file
upfront, or \emph{statically}. To demonstrate this, let us first add another
task to the above makefile:
