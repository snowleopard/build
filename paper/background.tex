...
abstract notion of \emph{keys} in~\S\ref{sec-vocabulary}.)
...
\caption{An early cutoff example.\label{fig-cutoff}}
\end{figure}
...
\subsection{Abstract vocabulary for build systems}\label{sec-vocabulary}
