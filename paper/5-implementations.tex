...
\begin{figure}
\begin{minted}[fontsize=\small]{haskell}
-- Approximation of task dependencies: a map of known upper bounds of dependencies
type ApproximateDependencies k = Map k [k]
\end{minted}
\vspace{1mm}
\begin{minted}[fontsize=\small]{haskell}
-- Build information: dirty keys, dependency approximation, and calculation chain
type CalcChain k = [k]
