...
familiar pattern. We discuss this in~\S\ref{sec-related-optics}.} \hs{Task}
describes how to build a value when given a way to build its dependencies, and is
best explained by an example. Consider this \Excel spreadsheet:
