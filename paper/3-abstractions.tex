...
Definition~\ref{def-minimal}); \hs{busy} keeps no track of keys it has already
brought up-to-date, and will therefore busily recompute the same keys again and
again if they have multiple dependents. We will develop much more efficient
