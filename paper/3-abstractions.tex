...
\begin{itemize}
    ...
    % is dedicated to the task dependency analysis.
...
\noindent
The implementation uses the standard Haskell \hs{Writer} monad: we instantiate
\hs{f} to \hs{Writer}~\hs{[@@k]}~\hs{v}, and feed
