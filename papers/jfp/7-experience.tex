...
polymorphic field; a higher-kinded type variable \hs{f :: * -> *}; an
even more abstracted kind for \hs{c :: (* -> *) -> Constraint}; and,
of course, type classes.

Moreover, when thinking about the type constructors over which \hs{f} might
