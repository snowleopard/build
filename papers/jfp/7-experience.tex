...
add concepts like \emph{resources} (for handling situations when two build tasks
...
were described in continuation-passing style using the data
...
report\footnote{\mbox{\url{https://groups.google.com/d/msg/shake-build-system/NbB5kMFS34I/mZ9L4TgkBwAJ}}}:
