...
\todo{AM: A section with examples of functorial, applicative and monadic tasks based on
  Collatz, Fibonacci and Ackermann sequences:
  https://blogs.ncl.ac.uk/andreymokhov/the-task-abstraction/}

\todo{AM: Maybe combine with the Edit Distance example from S7.3 Memoization?}

\todo{AM: Compute Functor = tail recursion
