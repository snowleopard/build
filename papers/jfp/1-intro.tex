...
executable and are available on Hackage as \cmd{build-1.0}.}. We use the
abstractions to explain confusing details from the original \Shake
paper~\cite{mitchell2012shake} and build new features useful for the GHC build
system~\cite{hadrian}.
