...
\todo{Tasks with multiple outputs:
...
\todo{Handling failures, see last section here:
...
\todo{Re-using existing infrastructure: (a) key-value store, (b) remote execution service.}
